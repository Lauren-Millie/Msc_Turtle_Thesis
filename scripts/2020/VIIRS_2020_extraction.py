...
NEST_LAYER_NAME = "VIIRS 2020 data"
...
# ============================================================
# FIND ALL LOADED 2020 VIIRS RASTERS
# ============================================================
...
if len(raster_layers) == 0:
    raise Exception(
        "No 2020 VIIRS raster layers were found."
    )
