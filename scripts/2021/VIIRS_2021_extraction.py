...
NEST_LAYER_NAME = "VIIRS 2021 data"
...
# ============================================================
# FIND ALL LOADED 2021 VIIRS RASTERS
# ============================================================
...
if len(raster_layers) == 0:
    raise Exception(
        "No 2021 VIIRS raster layers were found."
    )
