...
NEST_LAYER_NAME = "VIIRS 2022 data"
...
# ============================================================
# FIND ALL LOADED 2022 VIIRS RASTERS
# ============================================================
...
if len(raster_layers) == 0:
    raise Exception(
        "No 2022 VIIRS raster layers were found."
    )
